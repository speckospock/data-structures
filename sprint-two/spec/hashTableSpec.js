describe('hashTable', function() {
  ...
  it('should return the number of entries in the table', () => {
    hashTable.insert('Bob', 'Loblaw');
    hashTable.insert('Steven', 'Segal');
    expect(hashTable._size).to.equal(2);
    hashTable.insert('Peter', 'Pan');
    hashTable.insert('Peter', 'Dinklage');
    expect(hashTable._size).to.equal(3);
